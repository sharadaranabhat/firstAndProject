...
public class WednesdayFragment extends android.support.v4.app.ListFragment {
    ...
    final ViewBinder VIEW_BINDER = new ViewBinder() {
        ...
        public boolean setViewValue(View view, Cursor cursor, int columnIndex) {
            if (view.getId() == R.id.tv_subject) {
                String subjectName = cursor.getString(cursor
                        .getColumnIndex(RoutineDatabase.C_NAME_OF_SUBJECT));
                ...
                String subjectTeacher = cursor.getString(cursor
                        .getColumnIndex(RoutineDatabase.C_SUBJECT_TEACHER));
    ...
    public void onResume() {
        ...
        super.onResume();
        if (cursor == null) {
            cursor = KhECNoticeApplication.db_routine.getRoutineData("wednesday");
        }
        if (adapter == null) {
